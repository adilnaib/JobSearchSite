...
import com.cg.EmployerService.repository.JobApplicationRepository;
import com.cg.EmployerService.repository.JobRepository;
...
public class EmployerService {
    ...
    public Job editJob(Long jobId, Job job) {
        ...
        if (job.getJobCompanyEmail() != null) {
            existingJob.setJobCompanyEmail(job.getJobCompanyEmail());
        }
        ...
        existingJob.setNoticePeriodInDays(job.getNoticePeriodInDays());
